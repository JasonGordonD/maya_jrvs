  ...
  return (
    <Streamdown
      className={`
        ...
        prose-a:text-[var(--accent)] prose-a:no-underline hover:prose-a:text-[var(--text-primary)]
        prose-code:text-[var(--accent)] prose-code:bg-[var(--glass)] prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded-none prose-code:font-mono prose-code:border prose-code:border-[var(--border-subtle)]
        prose-pre:bg-[var(--bg-panel)] prose-pre:border prose-pre:border-[var(--border-medium)] prose-pre:rounded-none prose-pre:[backdrop-filter:blur(14px)]
        ...
        prose-blockquote:border-l-[var(--accent)] prose-blockquote:text-[var(--text-secondary)] prose-blockquote:bg-[var(--glass)] prose-blockquote:pl-4 prose-blockquote:py-1
